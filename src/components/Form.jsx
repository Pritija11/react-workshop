export default function Form() {
   ...
   return (
      <form className="flex flex-col justify-center max-w-lg mx-auto px-4 space-y-6 mt-2 bg-blue-200 ">
         ...
         <div>
            <label htmlFor="full-name-large" className="mb-2 text-slate-900 font-medium text-lg inline-block">Email
               </label>
            <input type="email" id="full-name-large" placeholder="Enter email"
